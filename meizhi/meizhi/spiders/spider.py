...
class Spider(scrapy.Spider):
	# userAgentList = ["Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/22.0.1207.1 Safari/537.1",
 ...
 # "Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/535.24 (KHTML, like Gecko) Chrome/19.0.1055.1 Safari/535.24"
	...
	def start_requests(self):
		...
		yield Request("https://www.zhihu.com/collection/38624707?page=1",callback = self.parse_pages,headers = self.headers)
